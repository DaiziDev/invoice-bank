...
export function Studio() {
      ...
      <Screen>
        ...
        <Body className="items-center justify-center">
          <div className="w-full max-w-[280px] flex flex-col gap-3">
            ...
            <input
              className={`input text-center mono text-xl tracking-[.4em] ${bad ? "border-danger" : ""}`}
              inputMode="numeric"
              value={code}
              autoFocus
              onChange={(e) => {
            ...
            />
            {bad && (
              <div className="text-[12.5px] text-danger text-center">
                {t("studioBad")}
              </div>
            )}
            <button
  ...
  return (
    <Screen>
      ...
      <Head
        title={t("studioTitle")}
        sub={s.lang === "fr" ? "Visible par vous seul" : "Visible to you only"}
      />
      <Body>
              ...
              >
                ...
                <span className="min-w-0">
                  ...
                  <span className="block text-[10.5px] text-muted truncate">
                    {b.features.interbank
                      ? b.appName
                      : `${b.appName} — interbancaire désactivé`}
                  </span>
                </span>
              </button>
            );
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex gap-2">
            <button
              ...
              onClick={() => setState({ lang: s.lang === "fr" ? "en" : "fr" })}
            >
              {s.lang.toUpperCase()}
            </button>
            <button
              className="btn btn-ghost btn-sm flex-[2]"
              onClick={() => {
                resetDemo();
                nav("/");
              }}
